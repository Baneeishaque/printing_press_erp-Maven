 ...
 * @author praveen
 */
public class Accounts_Income_Report extends javax.swing.JInternalFrame {

    private static Accounts_Income_Report instance;
     int initial_rowcnt;
    
    public Accounts_Income_Report() {
        initComponents();
    }
    ...
    private void initComponents()
    {
        ...
        displaydetails_jb = new javax.swing.JButton();
        ...
        setClosable(true);
        setTitle("Reports -> Accounts -> Incomes");
        ...
        searchby_jcb.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-Select-", "All", "Income Category", "Bank", "Cash" }));
        ...
        displaydetails_jb.setBackground(new java.awt.Color(185, 197, 31));
        displaydetails_jb.setText("Display");
        displaydetails_jb.setPreferredSize(new java.awt.Dimension(100, 27));
        displaydetails_jb.addMouseListener(new java.awt.event.MouseAdapter()
        {
            public void mouseClicked(java.awt.event.MouseEvent evt)
            {
                displaydetails_jbMouseClicked(evt);
            }
        });
        displaydetails_jb.addKeyListener(new java.awt.event.KeyAdapter()
        {
            public void keyPressed(java.awt.event.KeyEvent evt)
            {
                displaydetails_jbKeyPressed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 5;
        gridBagConstraints.gridy = 0;
        jPanel3.add(displaydetails_jb, gridBagConstraints);
        ...
        incomedetails_jt.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String []
            {
                "SNo", "ReceiptNo", "Date", "IncomeType", "IncomeItem", "Description", "From", "Amount"
            }
        )
        {
        ...
        jScrollPane2.setViewportView(incomedetails_jt);
        if (incomedetails_jt.getColumnModel().getColumnCount() > 0)
        {
            ...
            incomedetails_jt.getColumnModel().getColumn(2).setMinWidth(100);
            incomedetails_jt.getColumnModel().getColumn(2).setPreferredWidth(100);
            ...
            incomedetails_jt.getColumnModel().getColumn(6).setMinWidth(150);
            incomedetails_jt.getColumnModel().getColumn(6).setPreferredWidth(150);
            incomedetails_jt.getColumnModel().getColumn(7).setMinWidth(100);
            incomedetails_jt.getColumnModel().getColumn(7).setPreferredWidth(100);
        }
    ...
    public static Accounts_Income_Report getInstance()
    {
        
        if (instance == null)
            instance = new Accounts_Income_Report();
    ...
    private void getfirstdate()
    {
        ...
        try {
            ...
            ResultSet rs = stmt.executeQuery("SELECT entrydate FROM income_voucher");

            if (rs.first()) {

                String incvouch_date = rs.getString("entrydate");
                expvoucher_date_val = sdf2.parse(sdf2.format(sdf1.parse(incvouch_date)));
    ...
    private void searchby_jcbActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchby_jcbActionPerformed
        ...
        else if(searchby_jcb.getSelectedItem().toString().equals("Income Category"))
        {
    ...
    private void displaydetails_jbMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_displaydetails_jbMouseClicked
        // TODO add your handling code here:
    ...
    }//GEN-LAST:event_displaydetails_jbMouseClicked
    ...
    private void displaydetails_jbKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_displaydetails_jbKeyPressed
        // TODO add your handling code here:
    ...
    }//GEN-LAST:event_displaydetails_jbKeyPressed
    ...
    private void refresh_jbKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_refresh_jbKeyPressed
        ...
        if(evt.getKeyCode() == KeyEvent.VK_ENTER)
        {
            ...
            if(fromdate_jdc.getDate() != null && todate_jdc.getDate() != null && !searchby_jcb.getSelectedItem().toString().equals("-Select-"))
            {
                ...
                if(searchby_jcb.getSelectedItem().toString().equals("Income Type"))
                {
...
//            addMoreRows();
//            
//            String source = "income_report.jasper";
//           
...
//    }
        ...
        try {
            ...
            {   
                ...
                if(search_by_all_jchkbx.isSelected() == true)
                {
                    ...
                    sql = "SELECT * FROM income_voucher";
                ...
                if(search_by_date_jchkbx.isSelected() == true)
                {
                   ...
                   sql = "SELECT * FROM income_voucher WHERE entrydate BETWEEN '" + fromdate + "' AND '" + todate + "' ";

                }
            
            }
            
            if(searchby_jcb.getSelectedItem().toString().equals("Income Category"))
            {   
                ...
                if(search_by_all_jchkbx.isSelected() == true)
                {
                    ...
                    sql = "SELECT * FROM income_voucher WHERE income_type = '"+search_item+"' ";
                ...
                if(search_by_date_jchkbx.isSelected() == true)
                {
                    ...
                    sql = "SELECT * FROM income_voucher WHERE income_type = '"+search_item+"' AND entrydate BETWEEN '" + fromdate + "' AND '" + todate + "' ";
            ...
            {   
                ...
                if(search_by_all_jchkbx.isSelected() == true)
                {
                    ...
                    sql = "SELECT * FROM income_voucher WHERE to_bank != 'NA' ";
                ...
                if(search_by_date_jchkbx.isSelected() == true)
                {
                    ...
                    sql = "SELECT * FROM income_voucher WHERE to_bank != 'NA' AND entrydate BETWEEN '" + fromdate + "' AND '" + todate + "' ";
            ...
            {   
                ...
                if(search_by_all_jchkbx.isSelected() == true)
                {
                    ...
                    sql = "SELECT * FROM income_voucher WHERE to_cash = 'yes' ";
                ...
                if(search_by_date_jchkbx.isSelected() == true)
                {
                    ...
                    sql = "SELECT * FROM income_voucher WHERE to_cash = 'yes' AND entrydate BETWEEN '" + fromdate + "' AND '" + todate + "' ";
            ...
            while (rs.next()) {
                ...
                int rowcnt = incomedetails_jt.getRowCount();
                
                String[] strarr = new String[]{Integer.toString(rowcnt+1),voucher_no,exp_date_str,expense_type,expense_item,description,from,amount};
    ...
    private void displayexpensedetails_all()
    {
        ...
        try {
            ...
            Statement stmt = con.createStatement();
            ResultSet rs = stmt.executeQuery("SELECT * FROM income_voucher WHERE entrydate BETWEEN '" + fromdate + "' AND '" + todate + "' ");
    ...
    private void gettotals()
    {
        ...
        int rowcount = incomedetails_jt.getRowCount();
        BigDecimal big_amounttotal = new BigDecimal("0").setScale(2, RoundingMode.HALF_UP);
        BigDecimal big_counttemp = new BigDecimal("0").setScale(2, RoundingMode.HALF_UP);
        
        for(int i = 0 ; i < rowcount ; i++)
        {

            big_amounttotal =  (new BigDecimal(incomedetails_jt.getValueAt(i, 7).toString()).setScale(2, RoundingMode.HALF_UP)).add(big_counttemp);
            big_counttemp = big_amounttotal;
    ...
    private boolean validation()
    {
        ...
        else if(searchby_jcb.getSelectedItem().toString().equals("Income Category") && (searchitem_jcb.getSelectedItem().toString().equals("") || searchitem_jcb.getSelectedIndex() == -1 || searchitem_jcb.getSelectedItem() == null))
        {
    ...
    private void load_expensetypes_searchitem_jcb()
    {
        ...
        try {
            ...
            Statement stmt = con.createStatement();
            ResultSet rs = stmt.executeQuery("SELECT DISTINCT income_type FROM income_voucher");

            while (rs.next()) 
            {

                String income_type = rs.getString("income_type");  
                searchitem_jcb.addItem(income_type);
    ...
    private javax.swing.JButton displaydetails_jb;
