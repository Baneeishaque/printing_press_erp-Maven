 ...
 * @author praveen
 */
public class CutWorkOrderReport extends javax.swing.JInternalFrame {

    private static CutWorkOrderReport myInstance;
    
    public CutWorkOrderReport() {
        initComponents();
    ...
    private void initComponents()
    {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Reports > Cut Work Orders");
        ...
        searchresults_jt.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String []
            {
                "SNo", "WorkOrderId", "Customer", "OrderDate", "DelDate", "Rolls", "Rate", "Supplier", "Manufacturer", "CutterNote"
            }
        )
        {
    ...
    public static CutWorkOrderReport getInstance() // Method
    {
        if (myInstance == null)
	{
            myInstance = new CutWorkOrderReport();
	}
        return myInstance;
    }
    ...
    private void writeToExcel()
    {
        ...
        try
        {
            ...
            else
            {
                ...
                String filename = "CutWorkOrderReport-From_" + sdf1.format(fromdate_jdc.getDate()) + "_To_" + sdf1.format(todate_jdc.getDate());
    ...
    private void searchResults()
    {
        ...
        try
        {
            ...
            else
            {
                ...
                List<CutWorkOrder> allCutWorkOrderList = cutWorkOrder.getAllCutWorkOrderDetails(fromdate, todate);
                
                for (int i = 0; i < allCutWorkOrderList.size(); i++)
                {
                    String workorderid = allCutWorkOrderList.get(i).getWork_order_id();
                    String customer = allCutWorkOrderList.get(i).getCustomer();
                    String orderDate = sdf2.format(sdf1.parse(allCutWorkOrderList.get(i).getOrder_date()));
                    String delDate = sdf2.format(sdf1.parse(allCutWorkOrderList.get(i).getDelivery_date()));
                    String rolls = allCutWorkOrderList.get(i).getRolls();
                    String rate = allCutWorkOrderList.get(i).getRate();
                    String supplier = allCutWorkOrderList.get(i).getSupplier();
                    String manufacturer = allCutWorkOrderList.get(i).getManufacturer();
                    String cutternote = allCutWorkOrderList.get(i).getCutter_note();
                    
                    int rowcnt = searchresults_jt.getRowCount();
                    String[] strarr = new String[]{Integer.toString(rowcnt+1),workorderid,customer,orderDate,delDate,rolls,rate,supplier,manufacturer,cutternote};
