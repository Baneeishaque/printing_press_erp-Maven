 ...
 * @author praveen
 */
public class CutWorkOrderEdit extends javax.swing.JInternalFrame {

    private static CutWorkOrderEdit MyInstance;
    
    public CutWorkOrderEdit() {
        initComponents();
    }
    ...
    private void initComponents()
    {
        ...
        workOrderId_jcb = new javax.swing.JComboBox<>();
        showCutWorkOrderDetails_jb = new javax.swing.JButton();

        setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 255)));
        setClosable(true);
        setTitle("View/Edit > Cut Work Order");
        ...
        workOrderId_jcb.setEditable(true);
        workOrderId_jcb.setPreferredSize(new java.awt.Dimension(200, 25));
        workOrderId_jcb.addActionListener(new java.awt.event.ActionListener()
        {
            public void actionPerformed(java.awt.event.ActionEvent evt)
            {
                workOrderId_jcbActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(5, 0, 0, 0);
        jPanel1.add(workOrderId_jcb, gridBagConstraints);

        showCutWorkOrderDetails_jb.setBackground(new java.awt.Color(185, 197, 31));
        showCutWorkOrderDetails_jb.setText("Show");
        showCutWorkOrderDetails_jb.setPreferredSize(new java.awt.Dimension(100, 27));
        showCutWorkOrderDetails_jb.addMouseListener(new java.awt.event.MouseAdapter()
        {
            public void mouseClicked(java.awt.event.MouseEvent evt)
            {
                showCutWorkOrderDetails_jbMouseClicked(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(5, 0, 0, 0);
        jPanel1.add(showCutWorkOrderDetails_jb, gridBagConstraints);
    ...
    private void formInternalFrame_Opened()
    {
        ...
        load_workOrderId_jcb();
        SearchableCombobox searchableCombobox_4 = new SearchableCombobox(workOrderId_jcb);
        ((JTextField)workOrderId_jcb.getEditor().getEditorComponent()).addKeyListener(searchableCombobox_4);
    ...
    private void load_workOrderId_jcb()
    {
        try
        {
            workOrderId_jcb.removeAllItems();
            
            CutWorkOrder cutWorkOrder = new CutWorkOrder();
            List<String> workOrderIdList = cutWorkOrder.getWorkOrderIDs();
            
            for(int i = 0 ; i < workOrderIdList.size() ; i ++)
            {
                String mfrname = workOrderIdList.get(i);
                workOrderId_jcb.addItem(mfrname);
            }
          
            workOrderId_jcb.setSelectedItem("");
        }
        catch(Exception e)
        {
            JOptionPane.showMessageDialog(this, "load_workOrderId_jcb() : "+e);
        }
    }
    ...
    public static CutWorkOrderEdit getInstance() // Method
    {
        if (MyInstance == null)
	{
            MyInstance = new CutWorkOrderEdit();
	}
        return MyInstance;
    }
    ...
    {//GEN-HEADEREND:event_update_jbKeyPressed
        if(evt.getKeyCode() == KeyEvent.VK_ENTER)
        {
            updateCutWorkOrderDetails();
        }
    }//GEN-LAST:event_update_jbKeyPressed

    private void showCutWorkOrderDetails_jbMouseClicked(java.awt.event.MouseEvent evt)//GEN-FIRST:event_showCutWorkOrderDetails_jbMouseClicked
    {//GEN-HEADEREND:event_showCutWorkOrderDetails_jbMouseClicked
        showCutWorkOrderDetails();
    }//GEN-LAST:event_showCutWorkOrderDetails_jbMouseClicked

    private void workOrderId_jcbActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_workOrderId_jcbActionPerformed
    {//GEN-HEADEREND:event_workOrderId_jcbActionPerformed
        clearFields();
    }//GEN-LAST:event_workOrderId_jcbActionPerformed

    private void edit_jbMouseClicked(java.awt.event.MouseEvent evt)//GEN-FIRST:event_edit_jbMouseClicked
    {//GEN-HEADEREND:event_edit_jbMouseClicked
        update_jb.setEnabled(true);
        edit_jb.setEnabled(false);
    }//GEN-LAST:event_edit_jbMouseClicked

    private void showCutWorkOrderDetails()
    {
        if(workOrderId_jcb.getSelectedIndex() == -1)
        {
        ...
        else
        {
            try
            {
                ...
                String workOrderid = workOrderId_jcb.getSelectedItem().toString();

                CutWorkOrder cutWorkOrder = new CutWorkOrder();
                List<CutWorkOrder> cutWorkOrderDetailsList = cutWorkOrder.getCutWorkOrderDetails(workOrderid);

                for (int i = 0; i < cutWorkOrderDetailsList.size(); i++)
                {
                    String customer = cutWorkOrderDetailsList.get(i).getCustomer();
                    customer_jcb.setSelectedItem(customer);
                    String cutworkorderid = cutWorkOrderDetailsList.get(i).getWork_order_id();
                    workOrder_jl.setText(cutworkorderid);
                    Date orderDate = sdf2.parse(sdf2.format(sdf1.parse(cutWorkOrderDetailsList.get(i).getOrder_date())));
                    workOrderDate_jdc.setDate(orderDate);
                    Date delDate = sdf2.parse(sdf2.format(sdf1.parse(cutWorkOrderDetailsList.get(i).getDelivery_date())));
                    deliveryDate_jdc.setDate(delDate);
                    String jobName = cutWorkOrderDetailsList.get(i).getWork_name();
                    workName_jcb.setSelectedItem(jobName);
                    String gsm = cutWorkOrderDetailsList.get(i).getGsm();
                    gsm_jcb.setSelectedItem(gsm);
                    String sideLen = cutWorkOrderDetailsList.get(i).getSide_length();
                    sideLenght_jtf.setText(sideLen);
                    String sideBread = cutWorkOrderDetailsList.get(i).getSide_breadth();
                    sideBreadth_jtf.setText(sideBread);
                    String stringLen = cutWorkOrderDetailsList.get(i).getSide_length();
                    stringLength_jtf.setText(stringLen);
                    String stringBread = cutWorkOrderDetailsList.get(i).getString_breadth();
                    stringBreadth_jtf.setText(stringBread);
                    String beadingLen = cutWorkOrderDetailsList.get(i).getBeading_length();
                    beadingLength_jtf.setText(beadingLen);
                    String beadingBread = cutWorkOrderDetailsList.get(i).getBeading_breadth();
                    beadingBreadth_jtf.setText(beadingBread);
                    String rolls = cutWorkOrderDetailsList.get(i).getRolls();
                    rolls_jtf.setText(rolls);
                    String colour = cutWorkOrderDetailsList.get(i).getColour();
                    colour_jcb.setSelectedItem(colour);
                    String rate = cutWorkOrderDetailsList.get(i).getRate();
                    rate_jtf.setText(rate);
                    String supplier = cutWorkOrderDetailsList.get(i).getSupplier();
                    supplier_jcb.setSelectedItem(supplier);
                    String mfr = cutWorkOrderDetailsList.get(i).getManufacturer();
                    mfr_jcb.setSelectedItem(mfr);
                    if(cutWorkOrderDetailsList.get(i).getU_o_m().equals("centimeter"))
                    {
                        centimeter_jrb.setSelected(true);
                    }
                    else if(cutWorkOrderDetailsList.get(i).getU_o_m().equals("inch"))
                    {
                        inches_jrb.setSelected(true);
                    }
                    System.out.println("cutWorkOrderDetailsList.get(i).getU_o_m(): "+cutWorkOrderDetailsList.get(i).getU_o_m());
                    String cutterNote = cutWorkOrderDetailsList.get(i).getCutter_note();
    ...
    private void updateCutWorkOrderDetails()
    {
        boolean error = false;
        ...
        try
        {
            ...
            error = cutWorkOrder.updateCutWorkOrder(cutWorkOrder);
        }
        catch(Exception e)
        {
            JOptionPane.showMessageDialog(this, "updateCutWorkOrderDetails() : "+e);
            error = true;
        }
    ...
    private void newData()
    {
        ...
        workOrderId_jcb.requestFocusInWindow();
        update_jb.setEnabled(false);
        edit_jb.setEnabled(true);
    }
    ...
    private javax.swing.JButton showCutWorkOrderDetails_jb;
    ...
    private javax.swing.JComboBox<String> workOrderId_jcb;
